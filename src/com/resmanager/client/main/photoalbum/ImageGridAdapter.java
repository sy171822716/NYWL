...
import com.resmanager.client.main.photoalbum.BitmapCache.ImageCallback;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.iv.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if ((Bimp.drr.size() + selectTotal) < Bimp.MAX_SELECTED) {
				...
				} else if ((Bimp.drr.size() + selectTotal) >= Bimp.MAX_SELECTED) {
