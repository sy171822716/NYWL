...
import com.resmanager.client.scan.camera.CameraManager;
import com.resmanager.client.scan.decoding.CaptureActivityHandler;
import com.resmanager.client.scan.decoding.InactivityTimer;
import com.resmanager.client.scan.view.ViewfinderView;
...
public class CaptureActivity extends Activity implements Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ImageView leftImg = (ImageView) findViewById(R.id.title_left_img);
	...
	public void handleDecode(Result obj, Bitmap barcode) {
		...
		Intent it = new Intent(CaptureActivity.this, FlagManager.class);
